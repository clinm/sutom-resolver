package com.mclin.sutom.shared.collection.domain;
...
@UnitTest
class SutomResolverCollectionsTest {

  @Nested
  @DisplayName("Collections")
  class SutomResolverCollectionsCollectionsTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Collection<Object> input = null;
      Collection<Object> collection = SutomResolverCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Collection<String> collection = SutomResolverCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Set")
  class SutomResolverCollectionsSetTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Set<Object> input = null;
      Set<Object> set = SutomResolverCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Set<String> set = SutomResolverCollections.immutable(input);
  ...
  @Nested
  @DisplayName("List")
  class SutomResolverCollectionsListTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      List<Object> input = null;
      List<Object> list = SutomResolverCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      List<String> list = SutomResolverCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Map")
  class SutomResolverMapTest {

    @Test
    void shouldGetEmptyImmutableMapFromNullMap() {
      Map<Object, Object> input = null;
      Map<Object, Object> map = SutomResolverCollections.immutable(input);
    ...
    void shouldGetImmutableMapFromMutableMap() {
      ...
      input.put("key", "value");
      Map<String, String> map = SutomResolverCollections.immutable(input);
